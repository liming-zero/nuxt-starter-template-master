              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a href="#" title="开始学习" target="_blank" class="comm-btn c-btn-1">{{course.title}}</a>
                    </div>
                  </section>
...
//异步请求使用params.id可以获取路由中的id值，等价于this.$route.params.id
asyncData({ params,error }){
  return teacherApi.getTeacherInfo(params.id)  //id和文件名一样，_id即id
    .then(response =>{
      return{
